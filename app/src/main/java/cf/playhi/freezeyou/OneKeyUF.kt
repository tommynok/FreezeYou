...
class OneKeyUF : FreezeYouBaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Intent.ACTION_CREATE_SHORTCUT == intent.action) {
            ...
            intent.putExtra(
                ...
                Intent(this, OneKeyUF::class.java)
            )
            ...
            ServiceUtils.startService(this, Intent(applicationContext, OneKeyUFService::class.java))
        }
        finish()
    }
}
